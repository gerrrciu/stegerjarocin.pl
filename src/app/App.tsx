...
// 2. GŁÓWNY KOMPONENT WRAPPERA (Router musi otaczać całą aplikację)
...
// 3. WŁAŚCIWA ZAWARTOŚĆ APLIKACJI
function AppContent() {
  ...
  // Inteligentne przewijanie: jeśli jesteśmy w galerii, najpierw wraca na "/", a potem scrolluje
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-muted-foreground text-xs text-center leading-relaxed">
            ...
            <span className="text-[10px] text-muted-foreground/60 block mt-1">
              Kopiowanie, rozpowszechnianie zdjęcia oraz treści bez zgody autora jest zabronione.
            </span>
          </p>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur border-t border-border z-50 py-4 px-6 transition-all duration-300">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-muted-foreground text-xs sm:text-sm text-center sm:text-left max-w-3xl leading-relaxed">
              Nasza strona korzysta z plików cookies (ciasteczek) w celach statystycznych (Google Analytics) oraz aby zapewnić Ci maksymalną wygodę podczas przeglądania witryny. Możecz samodzielnie zarządzać cookies w ustawieniach swojej przeglądarki.
            </p>
            <button
